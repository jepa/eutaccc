...
test_stocks <-
  data.frame(
  taxon = c(
    rep(600118,4), # mackrel
    rep(600030,5), #hake HKE_5b_6_7_12_14
    rep(600024,3), # herring HER_2ª_4_7D 
    rep(601381,3), # hadock HAD_6B_12_14
    rep(600069,2), # Cod COD7XAD34
  ...
  division_keep = c(
    ...
    rep("7d",3), # herr
    rep("6b",3), # had
    c("7a","7d"), # cod NOT IN THESE AREAS
    c(NA,NA), # sol
    NA #ancho
  )
  )
